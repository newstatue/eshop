...
INSERT IGNORE INTO `spu` (`id`, `name`, `description`)
VALUES (1, 'iPhone 17', 'Apple iPhone 17 系列'),
...
INSERT IGNORE INTO `sku` (`spu_id`, `spec`, `price`, `stock`)
VALUES (1, '黑色/128G', 5999.00, 100),
...
INSERT IGNORE INTO `spu_image` (`spu_id`, `url`, `sort`)
VALUES (1, 'https://base.evorsio.com/storage/v1/object/public/eshop-bucket/iphone-17-black.webp', 0),
